...
5. a few markdown agendas aren't converting to HTML
...
10. add local time
11. detail view moving from open slides to try and open drafts gives error
12. Add favorites to Rooms?
13. More details for rooms (maybe room schedule)
14. add spinning circle when loading the sessions for a meeting?
15. In group list view, select, then filter, then select crashes
16. Show sessions at each location
17. have main app handle background downloads (error when app moves to bg)
18. pdf previews
